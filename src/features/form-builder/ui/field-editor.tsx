        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            <div className="flex items-start gap-3">
              ...
              <button
                type="button"
                className="flex min-w-0 flex-1 items-start justify-between gap-3 rounded-[20px] border border-transparent px-1 py-1 text-left transition-colors hover:bg-muted/38 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
              ...
              >
                <div className="min-w-0 flex flex-1 flex-wrap items-center gap-x-3 gap-y-2">
                  <div className="shrink-0 text-[1.05rem] font-semibold text-foreground">{fieldLabel}</div>
                  <span className="rounded-full border border-border/80 bg-white/82 px-2.5 py-1 text-xs font-medium text-muted-foreground">
